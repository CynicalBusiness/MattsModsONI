...
using static MattsMods.IndustrialFoundation.Mod;

namespace MattsMods.IndustrialFoundation.STRINGS
{
    public static class ELEMENTS
    {
        ...
        public static class SAWDUST
        {
            ...
            public static LocString DESC = $"A fine powder produced as a byproduct from processing {FormatAsLink("Wood", Tags.Log.Name)}.";
        }
        ...
        public static class CHARCOAL
        {
            ...
            public static LocString DESC = $"A coal-like material made mostly of carbon created from baking {FormatAsLink("Wood", Tags.RawLumber.Name)} in a low-{FormatAsLink("Oxygen", nameof(global::STRINGS.ELEMENTS.OXYGEN))} environment.";
        }
        #endregion
        #region Arbor Wood
        public static class LOGARBOR
        {
            public static LocString NAME = FormatAsLink("Arbor Logs", nameof(LOGARBOR));
            public static LocString DESC = $"Raw wooden logs from an {FormatAsLink("Arbor Tree", "FOREST_TREE")}.";
        }

        public static class LUMBERARBOR
        {
            public static LocString NAME = FormatAsLink("Arbor Lumber", nameof(LUMBERARBOR));
            public static LocString DESC = $"Cut lumber from {FormatAsLink("Arbor Logs", nameof(LOGARBOR))}.";
        }
        #endregion
        #endregion
