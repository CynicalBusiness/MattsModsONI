    ...
    public static class BUILDINGS
    {
        ...
        public static class PREFABS
        {
            ...
            public static class STORAGESKIP
            {
                ...
                public static LocString EFFECT = "A big bin to put all your rocks in.";
            }
            ...
            public static class STORAGEPALLET
            {
                ...
                public static LocString EFFECT = "It has holes in it for some sort of machine capable of moving it; if only we had one of those...";
            }
            ...
            public static class STORAGESILO
            {
                ...
                public static LocString EFFECT = "Don't question how things are kept separate. They just are.";
            }
            ...
            public static class STORAGECONTAINER
            {
                ...
                public static LocString EFFECT = "The ultimate storage solution.";
            ...
            public static class STORAGECONTAINERCOLD
            {
                ...
                public static LocString EFFECT = "The ultimate storage solution. Now with a cooling unit slapped on the side.";
            ...
            public static class STORAGEGAS
            {
                ...
                public static LocString EFFECT = "Caution: high-pressure gasses can be hazardous to Duplicant eardrums.";
            ...
            public static class STORAGELIQUID
            {
                ...
                public static LocString EFFECT = "Did you know spheres are the most energy-efficient 3D shape?";
            }
            ...
            public static class ICEBOX
            {
                ...
                public static LocString EFFECT = "It's like a fridge, but bigger.";
            }
        }
