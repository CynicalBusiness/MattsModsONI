...
namespace MattsMods.IndustrializationFundementals.STRINGS
{
    ...
    public static class RESEARCH
    {
        ...
        public static class TECHS
        {
            ...
            public static class CARPENTRYI
            {
                public static LocString NAME = FormatAsLink("Basic Carpentry", nameof(CARPENTRYI));
                public static LocString DESC = "Understanding of the basics of woodworking.";
            }
